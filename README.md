...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/concert360)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/concert360
```

A live public deployment of this template is available at [https://concert360.templates.workers.dev](https://concert360.templates.workers.dev)
